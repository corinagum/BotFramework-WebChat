...
-  Fix [#2022](https://github.com/Microsoft/BotFramework-WebChat/issues/2022). Fix Speech to respect InputHint by [@corinagum](https://github.com/corinagum) in PR [#xxxx](https://github.com/Microsoft/BotFramework-WebChat/pull/xxxx)
