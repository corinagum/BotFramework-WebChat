...
import startDictateAfterReceivingExpectingInputSaga from './sagas/startDictateAfterReceivingExpectingInputSaga';
...
export default function* sagas() {
  ...
  yield fork(startDictateAfterReceivingExpectingInputSaga);
